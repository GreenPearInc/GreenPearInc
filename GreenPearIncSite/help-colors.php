...
<!-- Mirrored from skrollex.x40.ru/theme-suzi/help-colors.php by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 06 Aug 2017 18:52:13 GMT -->
<head>
<meta charset="utf-8">
...
<div class="container">
<h3><span class="highlight">Color</span> Classes</h3>
<p class="text-center">Color schemes are specified using a CSS classes <strong class="highlight">colors-a</strong>, <strong class="highlight">colors-b</strong>, ... <strong class="highlight">colors-h</strong>.</p>
<div class="row">
<div class="col-lg-6">
<h4 class="highlight">Source</h4>
<pre class="example"><code class="language-markup">&lt;img alt class=&quot;bg&quot; src=&quot;images/placeholders/1920x1200img1.jpg&quot;/&gt;
&lt;section id=&quot;sec1&quot;&gt;
	&lt;div class=&quot;view&quot;&gt;
...
<div class="col-lg-6">
<h4 class="highlight">Result</h4>
<iframe class="example mobile-hide" src="help-colors-example-1.php"></iframe>
<a class="button mobile-only" target="_blank" href="help-colors-example-1.php">Show</a>
</div>
</div>
</div>
</div>
...
<div class="container">
<h3><span class="highlight">Customaize</span> Panel</h3>
<div class="row">
<div class="col-md-8 col-md-offset-2">
<p>You can use the Customize Panel to generate color schemes. Open the <a href="customize-mode.php" target="_blank" class="highlight">customize-mode.php</a> from web server to enable the Customize Panel. Click the toggle button (<i class="fa fa-cogs"></i>) on the left side to open the Customize Panel.
</p>
</div>
</div>
<div class="row">
<div class="col-md-4">
<p><img class="fluid-width" alt="Customize Panel" src="images/help/customize-panel-1.jpg"/></p>
<p>Use the Customize Panel to generate customized theme (file theme-custom.css).</p>
</div>
<div class="col-md-4">
<p><img class="fluid-width" alt="Customize Panel" src="images/help/customize-panel-2.jpg"/></p>
<p>Click the 'Save theme-custom.css' button to save changes.</p>
</div>
<div class="col-md-4">
<p><img class="fluid-width" alt="Customize Panel" src="images/help/customize-panel-3.jpg"/></p>
<p>
...
<a href="help-video.php" class="button">Next: Video Backgrounds</a>
</div>
</div>
</div>
</section>
...
<!-- Mirrored from skrollex.x40.ru/theme-suzi/help-colors.php by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 06 Aug 2017 18:52:14 GMT -->
</html>
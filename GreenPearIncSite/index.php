					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<p class="title text-center">
								¡Brindamos la mejor asesoria y solución a tu negocio para que llegue lejos!
							</p>
						</div>
					</div>
	...
	<section id="conocenos">
		...
		<div class="view" id="how-we-work">
			<div class="content colors-h">
				<div class="container">
					<h3><span class="highlight">¿Cómo</span> trabajamo?</h3>
					<div class="row">
	...
	<section id="services">
		<div class="view">
			<div class="content colors-e background-solid">
				<div class="container">
					<h2>Servicios</h2>
					<p class="header-details"><span class="highlight">Green Pear</span> esta contigo</p>
					...
					<div class="row">
						...
						<div class="col-md-3 top-line">
							...
							<ul class="simple">
								<li>Publicidad de Facebook</li>
								<li>SEO y SEM</li>
								<li>Facebook apps</li>
								<li>Context advertising</li>
								<li>Banners de medios enriquecidos</li>
						...
						<div class="col-md-3 top-line">
							<h4>Instalaciones de<br/>circuitos cerrados CCTV'S</h4>
						...
						<div class="col-md-3 top-line">
							<h4>Infrastructura de <br/>software y sistemas operativos</h4>
			...
			<div class="content half-size colors-h">
				<div class="container">
					<div class="show-list slogan">
						<div class="show-item">Somos diseñadores web</div>

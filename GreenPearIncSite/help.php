...
<!-- Mirrored from skrollex.x40.ru/theme-suzi/help.php by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 06 Aug 2017 18:51:49 GMT -->
<head>
<meta charset="utf-8">
...
<div class="row full-height">
<a href="index-2.php#how-we-work" class="col-md-4 colors-g background-solid full-height border-bottom border-lite">
<div>
<span class="side-label">Awesome</span>
<span class="side-title">How We Work</span>
</div>
</a>
<a href="index-2.php#who-we-are" class="col-md-4 colors-g background-solid full-height border-bottom border-left border-lite">
<div>
<span class="side-label">We Are Designers</span>
<span class="side-title">Who We Are</span>
</div>
</a>
<a href="index-2.php#numbers" class="col-md-4 colors-g background-solid full-height border-bottom border-left border-lite">
<div>
...
<a class="navbar-brand" href="index-2.php">SKROLL<span class="highlight">EX</span></a>
</div>
<div class="collapse navbar-collapse">
<ul class="nav navbar-nav navbar-right">
<li><a href="index-2.php" class="hover-effect">Home</a></li>
<li><a href="index-2.php#about" class="hover-effect">About</a></li>
<li><a href="index-2.php#team" class="hover-effect">Team</a></li>
<li><a href="index-2.php#services" class="hover-effect">Services</a></li>
<li><a href="index-2.php#work" class="hover-effect">Work</a></li>
<li><a href="index-2.php#process" class="hover-effect">Process</a></li>
<li><a href="index-2.php#skills" class="hover-effect">Skills</a></li>
<li><a href="index-2.php#contact" class="hover-effect">Contact</a></li>
...
<img alt class="bg" src="images/bg/stocksnap/37450BE2D6.jpg"/><img alt class="bg" src="images/bg/picjumbo/picjumbo.com_HNCK1805.jpg"/>
<section>
<div class="view">
<div class="content pane">
<div class="container-fluid">
<div class="row">
<div class="col-sm-6 colors-a background-40 full-size stretch-height hidden-xs">
<div class="row">
<div class="col-md-5 col-md-offset-7 help-toc-titles">
<h1>Help</h1>
<div class="help-toc-title highlight">Pages</div>
<div><i class="fa fa-file-text"></i> Skrollex Documentation</div>
<div><i class="fa fa-user"></i> By X40 Team</div>
</div>
</div>
</div>
<div class="col-sm-6 help-toc colors-f background-95 full-size stretch-height">
<h1 class="visible-xs-block text-left">Help <span class="highlight">Pages</span></h1>
<ul class="simple page-transition">
<li>
<a href="help.php#introduction">Introduction</a>
<ul>
<li><a href="help.php#content">Included Content</a></li>
<li><a href="help.php#credits">Sources and Credits</a></li>
<li><a href="help.php#start">Getting Started</a></li>
</ul>
</li>
<li>
<a href="help-layout.php">Page Layout</a>
<ul>
<li><a href="help-layout.php#representation">Page Representation</a></li>
<li><a href="help-layout.php#examples">Layout Examples</a></li>
</ul>
</li>
<li>
<a href="help-colors.php">Color Schemes</a>
<ul>
<li><a href="help-colors.php#color-classes">Color classes</a></li>
<li><a href="help-colors.php#panel">Customize Panel</a></li>
</ul>
</li>
<li>
<a href="help-video.php">Video Backgrounds</a>
<ul>
<li><a href="help-video.php#youtube">YouTube Video</a></li>
<li><a href="help-video.php#vimeo">Vimeo Video</a></li>
<li><a href="help-video.php#local">Local Video</a></li>
</ul>
</li>
<li>
<a href="help-elements.php">Elements</a>
<ul>
<li><a href="help-elements.php#template-elements">Template Elements</a></li>
<li><a href="help-elements.php#bootstrap-elements">Bootstrap Elements</a></li>
</ul>
</li>
<li>
<a href="help-icons.php">Icons</a>
<ul>
<li><a href="help-icons.php#fontawesome">Font Awesome</a></li>
<li><a href="help-icons.php#linecons">Linecons</a></li>
</ul>
</li>
</ul>
</div>
...
<div class="view">
<img alt class="bg" src="images/bg/picjumbo/picjumbo.com_IMG_4563.jpg"/><img alt class="bg" src="images/bg/pexels/coffee-coffee-machine-cup-3042.jpg"/>
<div class="content half-size colors-h">
<h2>Intro<span class="highlight">duction</span></h2>
<div class="header-details"><span class="highlight">Skrollex</span> Documentation</div>
</div>
</div>
<div class="view" id="content">
<img alt class="bg" src="images/bg/picjumbo/picjumbo.com_HNCK1805.jpg"/><img alt class="bg" src="images/bg/pexels/art-brush-colors-3112.jpg"/>
<div class="content colors-e background-95">
<div class="container">
<h3>Included <span class="highlight">Content</span></h3>
<div class="row">
<div class="col-md-6 col-md-offset-3">
<p>Root Folder:</p>
<ul class="simple">
<li>folders <strong class="highlight">theme-<b>...</b></strong> - template variants (theme-angie, theme-lynda, <b>...</b>);</li>
<li>file <strong class="highlight">index.php</strong> - page to select template variant (Demo 1, Demo 2, <b>...</b>);</li>
<li>folder <strong class="highlight">screenshots</strong> - screenshots of template variants.</li>
</ul>
<p>CSS Files:</p>
<ul class="simple">
<li>
<strong class="highlight">theme-<b>...</b>/theme-custom.css</strong> - defines colors. You can generate this file by Customize Panel;
</li>
<li>
<strong class="highlight">theme-<b>...</b>/styles/style.css</strong> - defines all other styles - layouts, sizes, fonts etc.
</li>
</ul>
<p>Background Files:</p>
<ul class="simple">
<li>folders <strong class="highlight">theme-<b>...</b>/images/bg</strong> - background images;</li>
<li>folders <strong class="highlight">theme-<b>...</b>/video</strong> - background video.</li>
</ul>
<p>Javascript Files:</p>
<ul class="simple">
<li><strong class="highlight">theme-<b>...</b>/scripts</strong> contains scripts of this template;</li>
<li><strong class="highlight">theme-<b>...</b>/bower_components</strong> contains <a href="http://bower.io/" target="_blank">Bower</a> libraries;</li>
<li><strong class="highlight">theme-<b>...</b>/lib</strong> contains other javascript libraries.</li>
</ul>
<p>Less Files:</p>
<ul class="simple">
<li>
Less files <strong class="highlight">theme-<b>...</b>/styles/style.less</strong> may be used to generate theme-<b>...</b>/styles/style.css by the less pre-processor;
</li>
<li>
Less files <strong class="highlight">theme-<b>...</b>/styles/themes/theme-<b>...</b>.less</strong> may be used to generate theme-<b>...</b>/styles/themes/theme-<b>...</b>.css by the less pre-processor.
</li>
</ul>
</div>
</div>
...
<img alt class="bg" src="images/bg/pexels/coffee-coffee-machine-cup-3042.jpg"/><img alt class="bg" src="images/bg/stocksnap/219FB68281.jpg"/>
<div class="content colors-h background-90">
<div class="container">
<div class="row">
<div class="col-md-6 col-md-offset-3 help-credits">
<h3>Sources <span class="highlight">and Credits</span></h3>
<ul>
<li>
Photos by:
<ul>
...
<div class="row">
<div class="col-md-6 col-md-offset-3">
<h3><span class="highlight">Getting</span> Started</h3>
<p>Upload files to web server and open template from web server.</p>
<p>If template is opened from local file system, some links, functions and examples may work incorrectly.</p>
<p>To customize template you can edit css and html files.</p>
<p>If you are familiar with the less preprocessor, you can use included less files.</p>
<p>Also you can use <a href="help-colors.php#panel" class="highlight">Customize Panel</a> to generate theme-<b>...</b>/theme-custom.css.</p>
<p>Animations disabled on mobile devices by default for performance reasons and may be enabled by changing line "var disableMobileAnimations = true;" to "var disableMobileAnimations = false;" in html.</p>
</div>
</div>
</div>
</div>
...
<div class="view">
<img alt class="bg" src="images/bg/picjumbo/picjumbo.com_IMG_4563.jpg"/><img alt class="bg" src="images/bg/pexels/coffee-coffee-machine-cup-3042.jpg"/>
<div class="content one-third-size colors-c background-90">
<div class="container text-center page-transition">
<a href="#top" class="button">Table of contents</a>
<a href="help-layout.php" class="button">Next: Page Layout</a>
</div>
</div>
</div>
</section>
...
<li><a href="index-2.php#how-we-work">How We Work</a></li>
<li><a href="index-2.php#who-we-are">Who We Are</a></li>
<li><a href="index-2.php#numbers">Our Numbers</a></li>
</ul>
</div>
<div class="col-md-3">
<h5>Recent Posts</h5>
...
<!-- Mirrored from skrollex.x40.ru/theme-suzi/help.php by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 06 Aug 2017 18:51:54 GMT -->
</html>